      ...
      {needsEnrollment && !qrCode && (
        <div>
          ...
          <input
            ...
            required
          />
          <button type="button" onClick={enroll} disabled={busy || !password}>Set up authenticator</button>
        </div>
      )}
      {qrCode && (
      ...
      {factorId && (
        <div>
          ...
          <input
            ...
            required
          />
          <button type="button" onClick={verify} disabled={busy || code.length !== 6}>Verify and continue</button>
        </div>
      )}
    </div>
  );
